...
export default function QualityAssuranceNavbar() {
  ...
  const navItems = [
    { key: 'Cypress', label: 'Cypress', icon: Terminal, component: Cypress },
    { key: 'Selenium', label: 'Selenium', icon: Shell, component: Selenium },
    { key: 'Playwright', label: 'Nmap', icon: Network, component: Playwright },
    { key: 'NightJS', label: 'NightJS', icon: Shield, component: NightJS },
    { key: 'Appium', label: 'Appium', icon: Rat, component: Appium },
    { key: 'Rest Assured', label: 'Rest Assured', icon: Crown, component: Restassured },
    { key: 'Super Test', label: 'Super Test', icon: GitBranch, component: SuperTest },
    { key: 'Grafana', label: 'Grafana', icon: Terminal, component: Grafana },
  ]
