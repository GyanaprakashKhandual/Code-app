...
const LyraLandingPage = () => {
  ...
  const developmentServices = [
    {
      name: "One Stack Web Applications",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Lyra empowers your team with cutting-edge SaaS solutions, automation tools, and next-generation development platforms that reduce testing time and streamline workflows.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover our comprehensive collection of innovative tools designed to revolutionize your development workflow and boost productivity.
            </p>
          </motion.div>
      ...
      <section id="services" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From automation testing to full-stack development, we provide comprehensive SaaS solutions tailored to your business needs.
            </p>
          </motion.div>
      ...
      <section id="testimonials" className="py-20 px-4 sm:px-6 lg:px-8 bg-white/50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Don't just take our word for it. See what industry leaders are saying about Lyra's transformative solutions.
            </p>
          </motion.div>
