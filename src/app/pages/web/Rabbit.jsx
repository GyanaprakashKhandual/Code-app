        ...
        <motion.div variants={itemVariants} className="mb-8">
          ...
          >
            <svg viewBox="0 0 24 24" className="w-10 h-10 text-white" fill="currentColor">
              ...
              <path d="M7 21L7.5 18.5L10 18L7.5 17.5L7 15L6.5 17.5L4 18L6.5 18.5L7 21Z"/>
            </svg>
          </motion.div>
          <motion.h1 
      ...
      >
        <motion.div variants={itemVariants}>
          ...
          <p className="text-gray-600 text-lg mb-12 max-w-2xl mx-auto">
            Transform your performance testing workflow with Rabbit's powerful suite of tools
          </p>
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.9 }}
          >
            <div className="w-24 h-24 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-full flex items-center justify-center shadow-xl">
