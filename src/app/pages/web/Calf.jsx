  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              >
                AI-Powered Testing Automation on the Cloud
              </motion.h1>
              <motion.p
              ...
              >
                Calf revolutionizes software testing with intelligent automation, AI-generated test cases, and comprehensive framework support - all in the cloud.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                  ...
                  <div className="bg-gray-800 rounded-lg p-4 text-white font-mono text-sm">
                    <div className="text-green-400">$ Calf init my-project</div>
                    ...
                    <div className="text-purple-400">✔ Project ready! Run 'Calf start' to begin</div>
                  </div>
                </div>
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Calf supports all major testing frameworks with AI-enhanced capabilities
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 Calf-8">
            <motion.div
      ...
      <section id="how-it-works" className="py-16 bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">How Calf Works</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Streamlined workflow from project setup to automated testing and reporting
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 Calf-8 relative">
      ...
      <section id="benefits" className="py-16 bg-white">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Why Choose Calf?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              The all-in-one cloud testing platform with AI integration
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 Calf-10">
            <motion.div
      ...
      <section className="py-16 bg-indigo-900 text-white">
        <div className="container mx-auto max-w-4xl text-center px-4">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Join thousands of developers and testers who have accelerated their workflow with Calf.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
